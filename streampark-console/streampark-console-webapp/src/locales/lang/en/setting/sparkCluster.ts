...
export default {
  ...
  form: {
    ...
    masterWebUrl: 'Master Web URL',
    runState: 'Run State',
    internal: 'internal cluster',
    deployMode: 'Deploy Mode',
    versionId: 'Spark Version',
    ...
    flinkImage: 'Spark Base Docker Image',
  ...
  placeholder: {
    ...
    versionId: 'Please select spark version',
    masterWebUrl: 'Master Web URL e.g: http://host:port',
    ...
    k8sConf: '~/.kube/config',
    flinkImage:
      'Please enter the tag of Spark base docker image, such as: flink:1.13.0-scala_2.11-java8',
  ...
  required: {
    masterWebUrl: 'spark web url  is required',
    deployMode: 'Deploy Mode is required',
    clusterId: 'Yarn Session Cluster is required',
    versionId: 'Spark Version is required',
    flinkImage: 'Spark Base Docker Image is required',
    resolveOrder: 'Resolve Order is required',
  },
  operateMessage: {
    createSparkSessionClusterSuccessful: ' create successful!',
    createSparkSessionClusterFailed: 'create cluster failed, please check log',
    ...
    updateSparkClusterSuccessful: ' update successful!',
  },
  view: {
    clusterId: 'ClusterId',
  },
